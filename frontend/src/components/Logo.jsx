  ...
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" data-testid="logo-mark">
    <defs>
      <linearGradient id={`trg-${id}`} x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="100%" stopColor="#7AE02E" />
      </linearGradient>
    </defs>
    ...
    <rect x="16" y="30" width="22" height="22" rx="6" transform="rotate(45 27 41)" stroke="#FAFAFA" strokeWidth="3.5" />
...
const Logo = ({ compact = false }) => (
  <div className="flex items-center gap-2" data-testid="logo">
    ...
    <span className={`font-semibold tracking-[-0.02em] ${compact ? "text-lg" : "text-xl"}`}>
      <span className="text-[#fafafa]">Tap</span>
